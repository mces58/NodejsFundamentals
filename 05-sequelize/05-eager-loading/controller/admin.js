...
exports.getProducts = async (req, res, next) => {
  try {
    const products = await Product.findAll({
      include: {
        model: Category,
        attributes: ["name"], // bu işlem ile category tablosundan sadece name alanını çekiyoruz.
      },
    }); // bu işlem ile product tablosu ile category tablosu arasında inner join işlemi gerçekleşir.
    // eager ile bütün verileri çekmiş oluyoruz ve bu sayede tek bir sorgu ile bütün verileri çekmiş oluyoruz.
